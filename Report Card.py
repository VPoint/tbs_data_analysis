...
depstats.to_csv(data_path+'Department Statistics.csv')
mainframe.to_csv(data_path+'Individual Statistics.csv')

#%%
depcounttime = users.groupby('Department').count()
depcounttime.to_csv(data_path+'Departmentusers.csv')
